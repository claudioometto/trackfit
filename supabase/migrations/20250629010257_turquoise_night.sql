/*
  # Sistema de Autenticação TrackFit
  ...
  2. Segurança
    ...
    - Relacionamentos com CASCADE DELETE para integridade
  ...
  4. Funcionalidades
    - Suporte completo a autenticação Supabase
...
-- INSERT INTO treinos (user_id, name, date, completed) 
-- VALUES (auth.uid(), 'Treino A - Peito e Tríceps', now(), false);